...
const LiveTrackingMap = () => {
    ...
    const [selectedFligthId, setSelectedFlightId] = useState();
        ...
        return (
            <div className="color-white">
                ...
                <div className="custom-card">
                    <button className="btn btn-primary px-3 py-2 mb-3" onClick={() => settogglebtn(!togglebtn)}><i className={togglebtn ? 'fas la-angle-down' : 'fas la-angle-up'}></i></button>
                    <div className={togglebtn ? 'custom-card-container show-top' : 'custom-card-container'}>
    ...
    const Events = () => {
        return (
            <div className="color-white">Assets</div>
        )
    }
